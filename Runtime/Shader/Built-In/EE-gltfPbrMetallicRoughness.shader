...
Shader "Ethereal Engine/PbrMetallicRoughness"
{
    Properties
    {
        ...
        lightMapIntensity("LightMap Intensity", Float) = 1.0
        lightMapTexture("LightMap Texture", 2D) = "white" {}
        lightMapTexture_Rotation ("LightMap Texture Rotation", Vector) = (0, 0, 0, 0)
        [Enum(UV0,0,UV1,1)] lightMapTexture_texCoord ("LightMap Tex UV", Float) = 0
